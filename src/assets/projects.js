export default {
  "spotify-player": {
    name: "Spotify Player Chrome Extension",
    type: "Project Type - Personal",
    date: "2021-11-30",
    description:
      "Spotify Player is a chrome extension used for controlling your spotify music. This mini-controller can be used with the <a href='https://open.spotify.com/' target='_blank'>Spotify web player</a>, Spotify desktop app as well as Spotify on your mobile. As long as you have authorized your Spotify account with this extension and have the Spotify app open in the background. I can perform actions such as Play, Stop, Skip, Like, Shuffle a track. It's built with JavaScript and Webpack.",
    links: {
      website:
        "https://chrome.google.com/webstore/detail/spotify-player%2B/haibeacocpobdaiimnfhjbkiggfacehc",
      github: "https://github.com/carlssonk/spotify-player",
    },
    background: "./assets/spotify-player_background.png",
  },
  flare: {
  ...
  blackjack: {
    ...
    date: "2020-08-10",
    description:
      "Blackjack Multiplayer Online is an online multiplayer casino game. It's similar to the traditional blackjack played at real casinos. You can choose to play alone or play in a private room with your friends. The goal of the game is to beat the dealer and win as much money as possible.\nI built this game using pure JavaScript and Sass for the frontend. For the backend I used Express.js as well as WebSockets for real time communication.",
    links: {
  ...
  bopshop: {
    name: "Bopshop.",
    type: "Project Type - School Project",
    date: "2021-09-05",
    description:
  ...
  music: {
    ...
    date: "2021-03-10",
    description:
      "Music Visualizer is a Spotify inspired music app that visualizes audio frequencies. Some basic features includes: play/stop song, skip to next song, skip to previous song, shuffle playlist, choose induvidual tracks from playlist etc.\nI built Music Visualizer using React.js, Sass, Web Audio API to retrieve audio frequencies and HTML Canvas to draw the spectrum and background particles.",
    links: {
  ...
  hemnet: {
    ...
    date: "2020-06-29",
    description:
      "Hemnet Clone is a 2020 clone of the Swedish real estate & housing platform <a href='https://www.hemnet.se/' target='_blank'>hemnet.se</a>. Built with VanillaJS and CSS.",
    links: {
  ...
  portfolio: {
    ...
    date: "2021-09-08",
    description:
      "This is the website you are viewing right now! I built this website for me to keep track and showcaase my projects i've worked on thorughout my career. It's built using Vanilla JavaScript, Scss and a cool library called <a href='https://vincentgarreau.com/particles.js/' target='_blank'>particles.js</a>",
    links: {
